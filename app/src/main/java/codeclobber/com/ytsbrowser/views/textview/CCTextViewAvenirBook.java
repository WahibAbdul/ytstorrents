...
public class CCTextViewAvenirBook extends TextView {
    public CCTextViewAvenirBook(Context context) {
        super(context);
        init(null);
    }

    public CCTextViewAvenirBook(Context context, AttributeSet attrs){
        super(context, attrs);
        init(attrs);
    }

    public CCTextViewAvenirBook(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CCTextViewAvenirBook(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
