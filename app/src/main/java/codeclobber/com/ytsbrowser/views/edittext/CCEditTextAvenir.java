...
public class CCEditTextAvenir extends EditText {
    public CCEditTextAvenir(Context context) {
        super(context);
        init(null);
    }

    public CCEditTextAvenir(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CCEditTextAvenir(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CCEditTextAvenir(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/Avenir_Book.otf"));
